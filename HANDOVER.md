...
**Current state:** 205 contest definitions → 823 occurrences for 2026. 368 Python tests,
381 TypeScript tests, 145 Worker tests. Engine complete in both languages — no known
...
cd engine; npm install; npm test   # expect: 381 passed (368 mirrored + 13 parity)
